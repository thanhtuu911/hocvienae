	...
	<style>
		...
		.sidebar-nav .sidebar-item:hover {
			padding-bottom: 0px;
			/* Đặt padding-bottom về 0 khi hover */
			border-bottom: 4px solid #c51b2c;
			...
			<nav id="sidebar" class="sidebar js-sidebar  ">
				<div class="sidebar-content js-simplebar">
					...
					<ul class="sidebar-nav">
						...
						<?php if (isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["loai"] == 1 || $_SESSION["nguoidung"]["loai"] == 2) { ?>
						...
						<?php if (isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["loai"] == 1) { ?>
							<li class="sidebar-item">
								<a class="sidebar-link" href="../qlkhachhang/index.php">
									<i class="fa-solid fa-user-group fa-xl" style="color: #c51b2c;"></i>
									<span class="align-middle">Quản Lý Khách Hàng</span>
								</a>
							</li>
						<?php } ?>
						...
						<?php if (isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["loai"] == 1) { ?>
							<li class="sidebar-item">
								<a class="sidebar-link" href="../qlhoadon/index.php">
									...
									<span class="align-middle">Quản Lý Hóa Đơn</span>
								</a>
							</li>
						<?php } ?>
					</ul>
								...
								<li class="nav-item dropdown">
									<a class="nav-icon dropdown-toggle" href="#" id="alertsDropdown" data-bs-toggle="dropdown">
										<div class="position-relative">
											...
											<span id="soHoaDonMoi" class="indicator">0</span> <!-- Hiển thị số hóa đơn mới -->
										</div>
									</a>
								...
								<li class="nav-item dropdown">
									...
									<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
										<img src="<?php if ($_SESSION["nguoidung"]["hinhanh"] == NULL) echo "../../image/account/2.jpg";
													else echo "../../" . $_SESSION["nguoidung"]["hinhanh"]; ?>" class="avatar img-fluid rounded me-1" />
									...
									<div class="dropdown-menu dropdown-menu-end">
										...
										<script>
											// JavaScript để thực hiện các hành động trên giao diện
											// Ajax request để lấy số hóa đơn mới từ máy chủ và cập nhật trên giao diện
											function laySoHoaDonMoi() {
												// Thực hiện Ajax request ở đây
												// Sau khi nhận được số hóa đơn mới, cập nhật nó trên giao diện
												var soHoaDonMoi = 0; // Đây là số hóa đơn mới nhận được từ máy chủ
												document.getElementById('soHoaDonMoi').innerText = soHoaDonMoi;
											}

											// JavaScript để đặt số hóa đơn mới về 0 khi người dùng click vào biểu tượng hóa đơn
											document.getElementById('alertsDropdown').addEventListener('click', function() {
												// Đặt số hóa đơn mới về 0
												document.getElementById('soHoaDonMoi').innerText = '0';
												// Thực hiện các hành động khác khi click vào biểu tượng hóa đơn
											});
										</script>
									</div>
								</li>
