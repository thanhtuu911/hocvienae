...
<form method="get">
    ...
    <button type="submit" class="btn btn-outline-danger">Xem thống kê theo ngày</button>
</form>
...
echo '<button type="submit" name="export_excel" class="btn btn-outline-success"><i class="fa-regular fa-file-excel fa-xl"></i> Xuất Excel</button>';
echo '</form>';
//end excel
