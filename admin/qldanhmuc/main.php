	...
	?>
		...
		?>
			<tr>
				...
				<td><a href="index.php?action=sua&id=<?php echo $d["id"]; ?>" class="btn btn-outline-warning"><i class="fa-solid fa-edit fa-fade fa-lg" style="color: #f1d93b;"></i></a></td>
				<td>
					<a href="javascript:void(0);" onclick="confirmDelete(<?php echo $d['id']; ?>);" class="btn btn-outline-danger">
