...
<div class="container mt-2">
    ...
    $soluonglophoc = count($lophoc);
    ?>
    <h2>Danh sách lớp học: <?php echo $soluonglophoc; ?> lớp học</h2>
            ...
            foreach ($lophoc as $l) :
                ...
                if (!$searchKeyword || stripos($l['tenlop'], $searchKeyword) !== false) : ?>
                    <tr>
                        ...
                        <td><?php echo date('d/m/Y', strtotime($l['ngaybatdau'])); ?></td>
                        <td><?php echo date('d/m/Y', strtotime($l['ngayketthuc'])); ?></td>
