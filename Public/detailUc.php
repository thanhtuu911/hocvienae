...
<div class=" container align-items-center mt-5 p-5 ">
    <h1 class="text-md-center mt-5 p-3" style ="color:#225473"> Du Học Úc </h1>
  ...
  <center>
    <div class="carousel-inner " style="width:1200px; height: 567px">
      <div class="carousel-item active ">
        <img src="../image/duhoc/u0.png" class="d-block w-100"  alt="...">
      </div>  
      <div class="carousel-item">
        <img src="../image/duhoc/u1.png" class="d-block w-100 "  alt="..."> 
      </div>
      <div class="carousel-item">
        <img src="../image/duhoc/u2.png" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="../image/duhoc/u3.png" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="../image/duhoc/u4.png" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="../image/duhoc/u5.png" class="d-block w-100" alt="...">
      </div>
    </div>
</center>
...
<h3 class="text-md-center mt-3" style ="color:#225473"> Chương trình Du học nghề tại Úc </h3> 
