    ...
    <nav class="navbar navbar-expand-sm navbar-dark  pl-5 fixed-top " style="background-color: #2C3D57 ;">
        ...
        <div class="container-fluid  pl-5">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                ?>
                    <ul >
                        <a href="index.php?action=thongtin" class="nav-link text-warning">Chào <?php echo $_SESSION["khachhang"]["hoten"]; ?></a></li>
                        <a href="index.php?action=dangxuat" class="btn btn-outline-info ">
                ...
                ?>
                    ...
                    <a href="index.php?action=giohang" class="btn btn-outline-light"><i class="bi bi-cart3"></i> <span class="badge bg-danger text-white ms-1 rounded-pill"><?php echo demhangtronggio() ?></span></a>
