...
<body id="top">
    ...
    <!-- Start Navigation -->
    <nav class="navbar navbar-expand-sm navbar-dark  pl-5 fixed-top " style="background-color: #2C3D57 ; text-align: center;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: center">
                <ul class="navbar-nav  custom-nav me-auto mb-2 mb-lg-0 ms-lg-4 ">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Trung Tâm AE</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Du Học</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <?php if (isset($_SESSION["khachhang"])) { ?>
                        <div class="nav_item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <li><a class="dropdown-item" href="index.php?action=giohang"><i class="fa-brands fa-cc-amazon-pay fa-fade fa-lg"style="color: #ea1a25;"></i> Thanh Toán</a></li>
                            </ul>
